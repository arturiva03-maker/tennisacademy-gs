...
const FEATURES = [
  {
    ...
    description:
      "Systematisches Erlernen und Verfeinern aller Schläge – von Vorhand bis Aufschlag.",
  },
  {
    id: "taktik",
    label: "Taktiktraining",
    icon: Brain,
    image:
      "https://images.unsplash.com/photo-1542144582-1ba00456b5e3?q=80&w=1200",
    description:
      "Spielverständnis entwickeln, Spielzüge automatisieren und den Gegner lesen lernen.",
  },
  {
    id: "gruppe",
    ...
    icon: Users,
    image:
      "https://images.unsplash.com/photo-1599586120429-48281b6f0ece?q=80&w=1200",
    description:
      "Spaß und Motivation in der Gruppe – ideal für Kinder, Jugendliche und Erwachsene.",
  },
  {
    id: "einzel",
    ...
    icon: User,
    image:
      "https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?q=80&w=1200",
    description:
      "100% individuelle Betreuung und gezielte Technikarbeit mit deinem Trainer.",
  },
  {
    id: "athletik",
    label: "Athletik & Kondition",
    icon: Dumbbell,
    image:
      "https://images.unsplash.com/photo-1526232761682-d26e03ac148e?q=80&w=1200",
    description:
      "Beinarbeit, Koordination, Schnelligkeit – die athletische Basis für dein Tennis.",
  },
  {
    id: "kids",
    label: "Kids on Court",
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] lg:rounded-[4rem] flex flex-col lg:flex-row min-h-[600px] lg:aspect-video border border-border/40">
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, var(--navy), rgba(22,61,94,0.8), transparent)",
            }}
          />
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, var(--navy), rgba(22,61,94,0.8), transparent)",
            }}
          />
                ...
                >
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-white text-[--navy] border-white z-10"
