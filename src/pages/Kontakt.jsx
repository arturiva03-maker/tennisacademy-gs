...
const T = {
  de: {
    ...
    noticeText: 'Aktuell sind unsere Jugendtrainingsplätze ausgelastet. Wir nehmen dein Kind gerne auf die Warteliste und melden uns, sobald ein Platz frei wird. Bitte sende uns eine Nachricht mit Name, Alter sowie Telefonnummer und E-Mail-Adresse.',
  ...
  en: {
    ...
    noticeText: 'Our junior training places are currently fully booked. We are happy to add your child to the waiting list and will get in touch as soon as a place becomes available. Please send us a message with the name, age, a phone number and an email address.',
